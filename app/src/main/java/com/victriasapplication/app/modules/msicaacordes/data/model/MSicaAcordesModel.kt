...
data class MSicaAcordesModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtTOMOne: String? = MyApp.getInstance().resources.getString(R.string.lbl_tom2)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtCAPOTRASTE: String? = MyApp.getInstance().resources.getString(R.string.lbl_capotraste)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtAFour: String? = MyApp.getInstance().resources.getString(R.string.lbl_g)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtASix: String? = MyApp.getInstance().resources.getString(R.string.lbl_c)
